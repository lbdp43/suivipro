...
export function getSeedData() {
  ...
  const prospects: Prospect[] = [
    {
      ...
      adresse: '12 Rue du Commerce', ville: 'Saint-Etienne', code_postal: '42000', departement: 'Loire',
      latitude: 45.4397, longitude: 4.3872, etape_pipeline: 'rdv_pris' as PipelineStage,
      tags: ['tag-2', 'tag-4'], commercial_id: 'com-2', notes: 'Tres interesse par la gamme bio',
    ...
    },
    {
      ...
      adresse: '5 Place du Marche', ville: 'Le Puy-en-Velay', code_postal: '43000', departement: 'Haute-Loire',
      latitude: 45.0435, longitude: 3.8853, etape_pipeline: 'contacte' as PipelineStage,
      tags: ['tag-7'], commercial_id: 'com-2', notes: 'Rappeler apres le 15 fevrier',
    ...
    },
    {
      ...
      adresse: '8 Rue Nationale', ville: 'Saint-Didier-en-Velay', code_postal: '43140', departement: 'Haute-Loire',
      latitude: 45.3003, longitude: 4.2789, etape_pipeline: 'proposition' as PipelineStage,
      tags: ['tag-2'], commercial_id: 'com-3', notes: 'Proposition envoyee, attente retour',
    ...
    },
    {
      ...
      adresse: '22 Avenue de la Liberation', ville: 'Saint-Etienne', code_postal: '42000', departement: 'Loire',
      latitude: 45.4340, longitude: 4.3900, etape_pipeline: 'nouveau' as PipelineStage,
      tags: ['tag-3'], commercial_id: 'com-2', notes: 'Hotel 3 etoiles, bar interieur',
    ...
    },
    {
      ...
      adresse: '15 Cours Gambetta', ville: 'Lyon', code_postal: '69003', departement: 'Rhone',
      latitude: 45.7578, longitude: 4.8532, etape_pipeline: 'a_contacter' as PipelineStage,
      tags: ['tag-1'], commercial_id: 'com-3', notes: 'GMS, volume important si accepte',
    ...
    },
    {
      ...
      adresse: '3 Rue de la Republique', ville: 'Monistrol-sur-Loire', code_postal: '43120', departement: 'Haute-Loire',
      latitude: 45.2936, longitude: 4.1714, etape_pipeline: 'gagne' as PipelineStage,
      tags: ['tag-2', 'tag-4'], commercial_id: 'com-2', notes: 'Client fidele, commande mensuelle',
    ...
    },
    {
      ...
      adresse: '11 Place Saint-Just', ville: 'Lyon', code_postal: '69005', departement: 'Rhone',
      latitude: 45.7600, longitude: 4.8200, etape_pipeline: 'negociation' as PipelineStage,
      tags: ['tag-5', 'tag-2'], commercial_id: 'com-3', notes: 'Actuellement chez un concurrent, interesse par nos prix',
    ...
    },
    {
      ...
      adresse: 'Place du Breuil', ville: 'Firminy', code_postal: '42700', departement: 'Loire',
      latitude: 45.3891, longitude: 4.2897, etape_pipeline: 'contacte' as PipelineStage,
      tags: ['tag-6'], commercial_id: 'com-2', notes: 'Marche hebdomadaire le samedi',
    ...
    },
    {
      ...
      adresse: 'ZI La Plaine', ville: 'Andrezieux-Boutheon', code_postal: '42160', departement: 'Loire',
      latitude: 45.5280, longitude: 4.2700, etape_pipeline: 'rdv_pris' as PipelineStage,
      tags: ['tag-2'], commercial_id: 'com-3', notes: 'Distributeur regional, gros potentiel',
    ...
    },
    {
      ...
      adresse: '7 Boulevard Marechal Fayolle', ville: 'Le Puy-en-Velay', code_postal: '43000', departement: 'Haute-Loire',
      latitude: 45.0450, longitude: 3.8870, etape_pipeline: 'perdu' as PipelineStage,
      tags: ['tag-1', 'tag-5'], commercial_id: 'com-2', notes: 'Budget trop serre, reste chez son fournisseur',
    ...
    },
    {
      ...
      adresse: '25 Rue Blatin', ville: 'Clermont-Ferrand', code_postal: '63000', departement: 'Puy-de-Dome',
      latitude: 45.7772, longitude: 3.0870, etape_pipeline: 'a_contacter' as PipelineStage,
      tags: ['tag-4'], commercial_id: 'com-3', notes: 'Magasin bio, fort interet potentiel',
    ...
    },
    {
      ...
      adresse: '1 Route du Meygal', ville: 'Les Estables', code_postal: '43150', departement: 'Haute-Loire',
      latitude: 44.9060, longitude: 4.1530, etape_pipeline: 'nouveau' as PipelineStage,
      tags: [], commercial_id: 'com-2', notes: 'Auberge de montagne, clientele touristique',
  ...
  const calls: Call[] = [
    ...
    { id: 'call-5', prospect_id: 'p-3', commercial_id: 'com-3', date: '2026-02-12T10:00:00Z', duree: 300, resultat: 'repondu' as CallResult, notes: 'Proposition envoyee par email' },
    { id: 'call-6', prospect_id: 'p-5', commercial_id: 'com-3', date: '2026-02-05T15:00:00Z', duree: 0, resultat: 'pas_de_reponse' as CallResult, notes: '' },
    { id: 'call-7', prospect_id: 'p-7', commercial_id: 'com-3', date: '2026-02-11T11:30:00Z', duree: 420, resultat: 'repondu' as CallResult, notes: 'Negociation en cours, demande tarifs volume' },
    ...
    { id: 'call-9', prospect_id: 'p-9', commercial_id: 'com-3', date: '2026-02-13T09:00:00Z', duree: 240, resultat: 'repondu' as CallResult, notes: 'RDV pris pour presentation gamme' },
    ...
    { id: 'call-13', prospect_id: 'p-11', commercial_id: 'com-3', date: '2026-02-13T14:00:00Z', duree: 0, resultat: 'pas_de_reponse' as CallResult, notes: '' },
  ...
  const appointments: Appointment[] = [
    ...
    {
      id: 'rdv-2', prospect_id: 'p-9', commercial_id: 'com-3',
    ...
    {
      id: 'rdv-4', prospect_id: 'p-7', commercial_id: 'com-3',
  ...
  const reminders: Reminder[] = [
    ...
    {
      id: 'rem-2', prospect_id: 'p-5', commercial_id: 'com-3',
    ...
    {
      id: 'rem-4', prospect_id: 'p-11', commercial_id: 'com-3',
